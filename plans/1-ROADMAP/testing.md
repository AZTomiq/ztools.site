# 🧪 iZTools Testing Strategy

Tài liệu này phác thảo kế hoạch triển khai hệ thống kiểm thử tự động (Testing) để đảm bảo chất lượng cho iZTools khi số lượng công cụ tăng lên.
