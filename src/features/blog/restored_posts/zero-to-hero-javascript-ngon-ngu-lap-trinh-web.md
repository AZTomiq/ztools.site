...
tags: [Async, DOM, ES6, Frontend, JavaScript, Modules, Promises, Web Development]
...
// Usage
const admin = UserFactory.createUser('admin', { name: 'John', permissions: ['read', 'write'] });
const customer = UserFactory.createUser('customer', { name: 'Jane', email: 'jane@example.com' });
```
